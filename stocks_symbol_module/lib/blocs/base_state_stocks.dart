...
abstract class BaseStateStocks<T> extends Equatable {
  final T? data;
...
class InitializedState<T> extends BaseStateStocks<T> {
  InitializedState({
    DateTime? timestamp,
    T? data,
  }) : super(
...
class LoadingState<T> extends BaseStateStocks<T> {
  LoadingState({
    DateTime? timestamp,
    T? data,
  }) : super(
...
class LoadedState<T> extends BaseStateStocks<T> {
  LoadedState({
    DateTime? timestamp,
    T? data,
  }) : super(
...
class SuccessState<T> extends BaseStateStocks<T> {
  SuccessState({
    DateTime? timestamp,
    T? data,
  }) : super(
...
class EmptyState<T> extends BaseStateStocks<T> {
  EmptyState({
    DateTime? timestamp,
    T? data,
  }) : super(
...
class ErrorState<T> extends BaseStateStocks<T> {
